...
using PharmAssist.UWP.Dependency;
using System;
...
[assembly: Xamarin.Forms.Dependency(typeof(SaveWindos))]
namespace PharmAssist.UWP.Dependency
{
    internal class SaveWindos : ISave
    {
